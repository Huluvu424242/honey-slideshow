...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-683d6927.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-bac5b6a8.js')); });
...
const runTransition = async (opts) => {
    ...
    const ani = (animationBuilder && core.Build.isBrowser)
