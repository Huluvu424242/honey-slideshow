...
const Alert = class {
    constructor(hostRef) {
        ...
        this.didPresent = core.createEvent(this, "ionAlertDidPresent", 7);
        this.willPresent = core.createEvent(this, "ionAlertWillPresent", 7);
        this.willDismiss = core.createEvent(this, "ionAlertWillDismiss", 7);
        this.didDismiss = core.createEvent(this, "ionAlertDidDismiss", 7);
    }
    buttonsChanged() {
    ...
    renderCheckbox(labelledby) {
        ...
        return (core.h("div", { class: "alert-checkbox-group", "aria-labelledby": labelledby }, inputs.map(i => (core.h("button", { type: "button", onClick: () => this.cbClick(i), "aria-checked": `${i.checked}`, id: i.id, disabled: i.disabled, tabIndex: 0, role: "checkbox", class: {
                'alert-tappable': true,
                'alert-checkbox': true,
                'alert-checkbox-button': true,
                'ion-focusable': true,
                'alert-checkbox-button-disabled': i.disabled || false
            } }, core.h("div", { class: "alert-button-inner" }, core.h("div", { class: "alert-checkbox-icon" }, core.h("div", { class: "alert-checkbox-inner" })), core.h("div", { class: "alert-checkbox-label" }, i.label)), mode === 'md' && core.h("ion-ripple-effect", null))))));
    }
    renderRadio(labelledby) {
        ...
        return (core.h("div", { class: "alert-radio-group", role: "radiogroup", "aria-labelledby": labelledby, "aria-activedescendant": this.activeId }, inputs.map(i => (core.h("button", { type: "button", onClick: () => this.rbClick(i), "aria-checked": `${i.checked}`, disabled: i.disabled, id: i.id, tabIndex: 0, class: {
                'alert-radio-button': true,
                'alert-tappable': true,
                'alert-radio': true,
                'ion-focusable': true,
                'alert-radio-button-disabled': i.disabled || false
            }, role: "radio" }, core.h("div", { class: "alert-button-inner" }, core.h("div", { class: "alert-radio-icon" }, core.h("div", { class: "alert-radio-inner" })), core.h("div", { class: "alert-radio-label" }, i.label)))))));
    }
    renderInput(labelledby) {
        ...
        return (core.h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
            if (i.type === 'textarea') {
                return (core.h("div", { class: "alert-input-wrapper" }, core.h("textarea", { placeholder: i.placeholder, value: i.value, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
            else {
                return (core.h("div", { class: "alert-input-wrapper" }, core.h("input", { placeholder: i.placeholder, value: i.value, type: i.type, min: i.min, max: i.max, onInput: e => i.value = e.target.value, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
    ...
    renderAlertButtons() {
        ...
        return (core.h("div", { class: alertButtonGroupClass }, buttons.map(button => core.h("button", { type: "button", class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, core.h("span", { class: "alert-button-inner" }, button.text), mode === 'md' && core.h("ion-ripple-effect", null)))));
    }
    render() {
        ...
        return (core.h(core.Host, { role: "dialog", "aria-modal": "true", tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'alert-translucent': this.translucent }), onIonAlertWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, core.h("ion-backdrop", { tappable: this.backdropDismiss }), core.h("div", { class: "alert-wrapper" }, core.h("div", { class: "alert-head" }, header && core.h("h2", { id: hdrId, class: "alert-title" }, header), subHeader && core.h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)), core.h("div", { id: msgId, class: "alert-message", innerHTML: index$3.sanitizeDOMString(this.message) }), this.renderAlertInputs(labelledById), this.renderAlertButtons())));
    }
