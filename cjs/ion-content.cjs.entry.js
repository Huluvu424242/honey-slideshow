...
const Content = class {
    ...
    resize() {
        if (this.fullscreen) {
            core.readTask(() => this.readDimensions());
        }
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
            ...
            } }, core.h("div", { id: "background-content", part: "background" }), core.h("main", { class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                'overscroll': (scrollX || scrollY) && forceOverscroll
            }, ref: el => this.scrollEl = el, onScroll: (this.scrollEvents) ? ev => this.onScroll(ev) : undefined, part: "scroll" }, core.h("slot", null)), transitionShadow ? (core.h("div", { class: "transition-effect" }, core.h("div", { class: "transition-cover" }), core.h("div", { class: "transition-shadow" }))) : null, core.h("slot", { name: "fixed" })));
    }
