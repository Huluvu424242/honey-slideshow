...
const Datetime = class {
    ...
    validateColumn(columns, name, index, min, max, lowerBounds, upperBounds) {
        ...
        const selectedIndex = column.selectedIndex = helpers$1.clamp(indexMin, column.selectedIndex, indexMax);
    ...
    render() {
        ...
        helpers$1.renderHiddenInput(true, el, this.name, this.value, this.disabled);
        return (core.h(core.Host, { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-haspopup": "true", "aria-labelledby": labelId, class: {
                [mode]: true,
                'datetime-disabled': disabled,
                'datetime-readonly': readonly,
                'datetime-placeholder': addPlaceholderClass,
                'in-item': theme.hostContext('ion-item', el)
            } }, core.h("div", { class: "datetime-text", part: datetimeTextPart }, datetimeText), core.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
    }
