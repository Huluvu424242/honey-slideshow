...
const utils = require('./utils-96effb26.js');
...
const Icon = class {
    ...
    waitUntilVisible(el, rootMargin, cb) {
        if (core.Build.isBrowser && this.lazy && typeof window !== 'undefined' && window.IntersectionObserver) {
    ...
    loadIcon() {
        if (core.Build.isBrowser && this.isVisible) {
    ...
    render() {
        ...
        return (core.h(core.Host, { role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) }, ((core.Build.isBrowser && this.svgContent)
...
const getIonMode = () => (core.Build.isBrowser && typeof document !== 'undefined' && document.documentElement.getAttribute('mode')) || 'md';
