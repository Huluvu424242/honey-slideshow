...
const ItemOption = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: this.onClick, class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'item-option-disabled': disabled, 'item-option-expandable': expandable, 'ion-activatable': true }) }, core.h(TagType, Object.assign({}, attrs, { class: "button-native", disabled: disabled }), core.h("span", { class: "button-inner" }, core.h("slot", { name: "top" }), core.h("div", { class: "horizontal-wrapper" }, core.h("slot", { name: "start" }), core.h("slot", { name: "icon-only" }), core.h("slot", null), core.h("slot", { name: "end" })), core.h("slot", { name: "bottom" })), mode === 'md' && core.h("ion-ripple-effect", null))));
    }
