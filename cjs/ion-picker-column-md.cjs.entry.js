...
const PickerColumnCmp = class {
    ...
    onEnd(detail) {
        ...
        this.velocity = helpers$1.clamp(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    refresh(forceRefresh) {
        ...
        const selectedIndex = helpers$1.clamp(min, this.col.selectedIndex || 0, max);
    ...
    render() {
        ...
        return (core.h(core.Host, { class: {
            ...
            } }, col.prefix && (core.h("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), core.h("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: el => this.optsEl = el }, col.options.map((o, index) => core.h(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text))), col.suffix && (core.h("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
    }
