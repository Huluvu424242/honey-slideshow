...
const Popover = class {
    constructor(hostRef) {
        ...
        this.didPresent = core.createEvent(this, "ionPopoverDidPresent", 7);
        this.willPresent = core.createEvent(this, "ionPopoverWillPresent", 7);
        this.willDismiss = core.createEvent(this, "ionPopoverWillDismiss", 7);
        this.didDismiss = core.createEvent(this, "ionPopoverDidDismiss", 7);
    }
    /**
    ...
    render() {
        ...
        return (core.h(core.Host, { "aria-modal": "true", "no-router": true, tabindex: "-1", style: {
                zIndex: `${20000 + this.overlayIndex}`,
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'popover-translucent': this.translucent }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonDismiss: this.onDismiss, onIonBackdropTap: this.onBackdropTap }, core.h("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop }), core.h("div", { class: "popover-wrapper" }, core.h("div", { class: "popover-arrow" }), core.h("div", { class: "popover-content" }))));
    }
