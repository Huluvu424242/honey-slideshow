...
const Router = class {
    constructor(hostRef) {
         ...
         */
        this.useHash = true;
        this.ionRouteWillChange = core.createEvent(this, "ionRouteWillChange", 7);
        this.ionRouteDidChange = core.createEvent(this, "ionRouteDidChange", 7);
    }
    ...
    componentDidLoad() {
        window.addEventListener('ionRouteRedirectChanged', helpers$1.debounce(this.onRedirectChanged.bind(this), 10));
        window.addEventListener('ionRouteDataChanged', helpers$1.debounce(this.onRoutesChanged.bind(this), 100));
    }
    onPopState() {
