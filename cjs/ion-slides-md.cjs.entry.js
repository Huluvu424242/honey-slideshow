...
const Slides = class {
    constructor(hostRef) {
        ...
        this.ionSlidesDidLoad = core.createEvent(this, "ionSlidesDidLoad", 7);
        this.ionSlideTap = core.createEvent(this, "ionSlideTap", 7);
        this.ionSlideDoubleTap = core.createEvent(this, "ionSlideDoubleTap", 7);
        this.ionSlideWillChange = core.createEvent(this, "ionSlideWillChange", 7);
        this.ionSlideDidChange = core.createEvent(this, "ionSlideDidChange", 7);
        this.ionSlideNextStart = core.createEvent(this, "ionSlideNextStart", 7);
        this.ionSlidePrevStart = core.createEvent(this, "ionSlidePrevStart", 7);
        this.ionSlideNextEnd = core.createEvent(this, "ionSlideNextEnd", 7);
        this.ionSlidePrevEnd = core.createEvent(this, "ionSlidePrevEnd", 7);
        this.ionSlideTransitionStart = core.createEvent(this, "ionSlideTransitionStart", 7);
        this.ionSlideTransitionEnd = core.createEvent(this, "ionSlideTransitionEnd", 7);
        this.ionSlideDrag = core.createEvent(this, "ionSlideDrag", 7);
        this.ionSlideReachStart = core.createEvent(this, "ionSlideReachStart", 7);
        this.ionSlideReachEnd = core.createEvent(this, "ionSlideReachEnd", 7);
        this.ionSlideTouchStart = core.createEvent(this, "ionSlideTouchStart", 7);
        this.ionSlideTouchEnd = core.createEvent(this, "ionSlideTouchEnd", 7);
    }
    ...
    async initSwiper() {
        ...
        // init swiper core
        // @ts-ignore
        const { Swiper } = await new Promise(function (resolve) { resolve(require('./swiper.bundle-1628eacb.js')); });
    ...
    render() {
        ...
        return (core.h(core.Host, { class: {
            ...
            } }, core.h("div", { class: "swiper-wrapper" }, core.h("slot", null)), this.pager && core.h("div", { class: "swiper-pagination", ref: el => this.paginationEl = el }), this.scrollbar && core.h("div", { class: "swiper-scrollbar", ref: el => this.scrollbarEl = el })));
    }
