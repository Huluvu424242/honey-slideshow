...
const TabButton = class {
    constructor(hostRef) {
        ...
        this.ionTabButtonClick = core.createEvent(this, "ionTabButtonClick", 7);
    }
    onTabBarChanged(ev) {
    ...
    componentWillLoad() {
        if (this.layout === undefined) {
            this.layout = core.config.get('tabButtonLayout', 'icon-top');
        }
    }
    selectTab(ev) {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                [mode]: true,
                ...
                'ion-selectable': true,
                'ion-focusable': true
            } }, core.h("a", Object.assign({}, attrs, { tabIndex: -1, class: "button-native" }), core.h("span", { class: "button-inner" }, core.h("slot", null)), mode === 'md' && core.h("ion-ripple-effect", { type: "unbounded" }))));
    }
