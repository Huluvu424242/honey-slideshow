...
const VirtualScroll = class {
    ...
    updateVirtualScroll() {
        ...
        core.readTask(this.readVS.bind(this));
        core.writeTask(this.writeVS.bind(this));
    }
    readVS() {
    ...
    render() {
        return (core.h(core.Host, { style: {
            ...
            } }, this.renderItem && (core.h(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map(node => this.renderVirtualNode(node))))));
    }
