...
const hardwareBackButton = require('./hardware-back-button-886c770d.js');
...
const present = async (overlay, name, iosEnterAnimation, mdEnterAnimation, opts) => {
    ...
    const mode = core.getIonMode(overlay);
    // get the user's animation fn if one was provided
    const animationBuilder = (overlay.enterAnimation)
        ? overlay.enterAnimation
        : core.config.get(name, mode === 'ios' ? iosEnterAnimation : mdEnterAnimation);
...
const dismiss = async (overlay, data, role, name, iosLeaveAnimation, mdLeaveAnimation, opts) => {
    ...
    try {
        ...
        const animationBuilder = (overlay.leaveAnimation)
            ...
            : core.config.get(name, mode === 'ios' ? iosLeaveAnimation : mdLeaveAnimation);
