import { r as registerInstance, i as createEvent, j as forceUpdate, e as getIonMode, h, H as Host, c as getElement } from './core-890aed19.js';
...
var Alert = /** @class */ (function () {
    ...
    Alert.prototype.renderInput = function (labelledby) {
        ...
        return (h("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(function (i) {
            if (i.type === 'textarea') {
                return (h("div", { class: "alert-input-wrapper" }, h("textarea", { placeholder: i.placeholder, value: i.value, onInput: function (e) { return i.value = e.target.value; }, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
            else {
                return (h("div", { class: "alert-input-wrapper" }, h("input", { placeholder: i.placeholder, value: i.value, type: i.type, min: i.min, max: i.max, onInput: function (e) { return i.value = e.target.value; }, id: i.id, disabled: i.disabled, tabIndex: 0, class: {
                        'alert-input': true,
                        'alert-input-disabled': i.disabled || false
                    } })));
            }
