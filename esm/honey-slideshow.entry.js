import { r as registerInstance, h, f as getElement } from './core-df18ef15.js';
...
const HoneySlideshow = class {
    ...
    render() {
        return (h("host", null, h("header", null, h("slot", { name: "title" }, "Platzhalter f\u00FCr den Titel der Pr\u00E4sentation"), h("div", { id: "taglist", class: "tag-container" }, this.tags.map((tag) => h("span", { class: "tag-content" }, tag)))), h("hr", { class: "hr-oben" }), h("div", { id: "slide-control", class: "flex-container" }, h("button", { onClick: (event) => this.handleStart(event), disabled: this.slide < 1, class: "flex-content", title: "Zur ersten Folie", innerHTML: IMG_START }), h("button", { onClick: (event) => this.handleFastRewind(event), disabled: (this.slide - 10) < 0, class: "flex-content", title: "10 Folien zurück", innerHTML: IMG_FASTREWIND }), h("button", { onClick: (event) => this.handleRewind(event), disabled: (this.slide - 1) < 0, class: "flex-content", title: "1 Folie zurück", innerHTML: IMG_REWIND }), h("button", { onClick: (event) => this.isPlayingMode && this.isPausierend ? this.handlePause(event) : this.handlePlay(event), disabled: this.isPlayingMode && !this.isPausierend, id: "playbutton", class: "flex-content", title: this.isPlayingMode && this.isPausierend ? "Sprachausgabe fortsetzen" : "Vortrag beginnen lassen", innerHTML: IMG_PLAY }), h("button", { onClick: (event) => this.handlePause(event), disabled: !this.isPlayingMode || this.isPausierend, class: "flex-content", title: "Sprachausgabe pausieren", innerHTML: IMG_PAUSE }), h("button", { onClick: (event) => this.handleStop(event), disabled: !this.isPlayingMode, class: "flex-content", title: "Sprachausgabe beenden", innerHTML: IMG_STOP }), h("button", { onClick: (event) => this.handleForeward(event), disabled: (this.slide + 1) > (this.slides.length - 1), class: "flex-content", title: "1 Folie weiter", innerHTML: IMG_FOREWARD }), h("button", { onClick: (event) => this.handleFastForeward(event), disabled: (this.slide + 10) > (this.slides.length - 1), class: "flex-content", title: "10 Folien weiter", innerHTML: IMG_FASTFOREWARD }), h("button", { onClick: (event) => this.handleEnd(event), disabled: this.slide >= (this.slides.length - 1), class: "flex-content", title: "Zur letzten Folie", innerHTML: IMG_END }), h("div", { id: "pagenum", title: this.printPageNum() }, this.printPageNum())), h("hr", { class: "hr-unten" }), h("main", null, h("div", null, "Quelle: ", this.getCurrentSlideURLExternalForm()), h("slot", { name: "slide-area" }))));
    }
