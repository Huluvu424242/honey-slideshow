import { r as registerInstance, e as createEvent, B as Build, c as getIonMode, d as config, h, f as getElement } from './core-df18ef15.js';
import { a as attachComponent } from './framework-delegate-1455d79b.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-a78473ab.js';
import { b as assert } from './helpers-c3aa5e98.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await import('./swipe-back-f0548322.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
