import { r as registerInstance, e as createEvent, d as config, c as getIonMode, h, H as Host, f as getElement } from './core-df18ef15.js';
...
const TabButton = class {
    ...
    render() {
        ...
        return (h(Host, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                ...
                'ion-selectable': true,
                'ion-focusable': true
            } }, h("a", Object.assign({}, attrs, { tabIndex: -1, class: "button-native" }), h("span", { class: "button-inner" }, h("slot", null)), mode === 'md' && h("ion-ripple-effect", { type: "unbounded" }))));
    }
